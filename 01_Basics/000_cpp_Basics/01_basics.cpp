...
// We will follow the convention of indicating user-defined types by capi-
// talizing the first character of their names.
...
int main() {
  ...
  // a[] is same as *a or value at the address stored in the pointer a
  // a[i] is same as *(a+i) or value at the address a+i
  ...
  */
  ...
  //********** C++ does not provide automatic garbage collection. This means
  // that C++ programmers have the responsibility of explicitly deleting all
